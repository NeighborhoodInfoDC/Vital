  ...
  ** Recombine records **;
  ...
  data Vital.Births_&year (label="Individual birth records, &year, DC");
    ...
    ** By age of mother **;
    ...
    %if &year >= &FIRST_YEAR_LATINO %then %do;
      %By_race( Births_teen, under 20 years old, Births, var2=Births)
      %By_race( Births_under18, under 18 years old, Births, var2=Births )
      %By_race( Births_under15, under 15 years old, Births, var2=Births )
      %By_race( Births_20to24, 20-24 years old, Births, var2=Births )
      %By_race( Births_w_age, with age reported, Births, var2=Births )
    %end;
    ...
    ** By birth weight **;
    ...
    %if &year >= &FIRST_YEAR_LATINO %then %do;
      %By_race( Births_low_wt, with low birth weight (<5.5 lbs), Births, var2=Births )
      %By_race( Births_w_weight, with birth weight reported, Births, var2=Births )
    %end;
    ...
    ** Single mother births **;
      ...
      %if &year >= &FIRST_YEAR_LATINO %then %do;
        %By_race( Births_single, who were unmarried, Births, var2=Births )
        %By_race( Births_w_mstat, with marital status reported, Births, var2=Births )
      %end;
    ...
    %if &year >= &FIRST_YEAR_PRENATAL %then %do;
      ...
      ** Prenatal care **;
      ...
      %if &year >= &FIRST_YEAR_LATINO %then %do;
        %By_race( Births_prenat_1st, with prenatal care in 1st trimester, Births, var2=Births )
        %By_race( Births_prenat_adeq, with adequate prenatal care, Births, var2=Births )
        %By_race( Births_prenat_intr, with intermediate prenatal care, Births, var2=Births )
        %By_race( Births_prenat_inad, with inadequate prenatal care, Births, var2=Births )
        %By_race( Births_w_prenat, with prenatal care reported, Births, var2=Births )
      %end;
...
%Read_births08( infile=B08URBAN_60611, year=2008 )
